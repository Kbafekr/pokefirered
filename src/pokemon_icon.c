...
const u8 *const gMonIconTable[] = {
    ...
    [SPECIES_BULBASAUR2]   = gMonIcon_Bulbasaur2,
    [SPECIES_IVYSAUR2]     = gMonIcon_Ivysaur2,
    [SPECIES_VENUSAUR2]    = gMonIcon_Venusaur2,
    [SPECIES_CHARMANDER]  = gMonIcon_Charmander,
    [SPECIES_CHARMANDER2]  = gMonIcon_Charmander2,
    [SPECIES_CHARMELEON]  = gMonIcon_Charmeleon,
    [SPECIES_CHARMELEON2]  = gMonIcon_Charmeleon2,
    [SPECIES_CHARIZARD]   = gMonIcon_Charizard,
    [SPECIES_CHARIZARD2]   = gMonIcon_Charizard2,
    [SPECIES_SQUIRTLE]    = gMonIcon_Squirtle,
    [SPECIES_WARTORTLE]   = gMonIcon_Wartortle,
    [SPECIES_BLASTOISE]   = gMonIcon_Blastoise,
    [SPECIES_SQUIRTLE2]    = gMonIcon_Squirtle2,
    [SPECIES_WARTORTLE2]   = gMonIcon_Wartortle2,
    ...
    [SPECIES_NIDORAN_M1]   = gMonIcon_NidoranM1,
    [SPECIES_NIDORINO1]    = gMonIcon_Nidorino1,
    [SPECIES_NIDOKING1]    = gMonIcon_Nidoking1,
    ...
    [SPECIES_SNORLAX2]    = gMonIcon_Snorlax2,
...
const u8 gMonIconPaletteIndices[] = {
    ...
    [SPECIES_IVYSAUR]     = 1,
    [SPECIES_VENUSAUR]    = 1,
    [SPECIES_BULBASAUR2]   = 1,
    [SPECIES_IVYSAUR2]     = 1,
    [SPECIES_VENUSAUR2]    = 1,
    [SPECIES_CHARMANDER]  = 0,
    [SPECIES_CHARMELEON]  = 0,
    [SPECIES_CHARIZARD]   = 0,
    [SPECIES_CHARMANDER2]  = 0,
    [SPECIES_CHARMELEON2]  = 0,
    [SPECIES_CHARIZARD2]   = 0,
    [SPECIES_SQUIRTLE]    = 0,
    [SPECIES_WARTORTLE]   = 2,
    [SPECIES_BLASTOISE]   = 2,
    [SPECIES_SQUIRTLE2]    = 0,
    [SPECIES_WARTORTLE2]   = 2,
