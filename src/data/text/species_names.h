const u8 gSpeciesNames[][POKEMON_NAME_LENGTH + 1] = {
    ...
    [SPECIES_BULBASAUR2] = _("BULBASAUR"),
    [SPECIES_IVYSAUR2] = _("IVYSAUR"),
    [SPECIES_VENUSAUR2] = _("VENUSAUR"),
    [SPECIES_CHARMANDER] = _("CHARMANDER"),
    [SPECIES_CHARMELEON] = _("CHARMELEON"),
    [SPECIES_CHARIZARD] = _("CHARIZARD"),
    [SPECIES_CHARMANDER2] = _("CHARMANDER"),
    [SPECIES_CHARMELEON2] = _("CHARMELEON"),
    [SPECIES_CHARIZARD2] = _("CHARIZARD"),
    [SPECIES_SQUIRTLE] = _("SQUIRTLE"),
    [SPECIES_WARTORTLE] = _("WARTORTLE"),
    [SPECIES_BLASTOISE] = _("BLASTOISE"),
    [SPECIES_SQUIRTLE2] = _("SQUIRTLE"),
    [SPECIES_WARTORTLE2] = _("WARTORTLE"),
    ...
    [SPECIES_NIDORAN_M1] = _("NIDORAN♂"),
    [SPECIES_NIDORINO1] = _("NIDORINO"),
    [SPECIES_NIDOKING1] = _("NIDOKING"),
    ...
    [SPECIES_MAGIKARP1] = _("MAGIKARP"),
    [SPECIES_GYARADOS1] = _("GYARADOS"),
    [SPECIES_LAPRAS] = _("LAPRAS"),
    [SPECIES_LAPRAS1] = _("LAPRAS"),
    [SPECIES_DITTO] = _("DITTO"),
    [SPECIES_EEVEE] = _("EEVEE"),
    [SPECIES_EEVEE1] = _("EEVEE"),
    [SPECIES_VAPOREON] = _("VAPOREON"),
    [SPECIES_JOLTEON] = _("JOLTEON"),
    [SPECIES_JOLTEON1] = _("JOLTEON"),
