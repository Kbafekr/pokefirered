const struct CompressedSpriteSheet gMonFrontPicTable[] =
{
    ...
    SPECIES_SPRITE(BULBASAUR2, gMonFrontPic_Bulbasaur2),
    SPECIES_SPRITE(IVYSAUR2, gMonFrontPic_Ivysaur2),
    SPECIES_SPRITE(VENUSAUR2, gMonFrontPic_Venusaur2),
    ...
    SPECIES_SPRITE(CHARMANDER2, gMonFrontPic_Charmander2),
    SPECIES_SPRITE(CHARMELEON2, gMonFrontPic_Charmeleon2),
    SPECIES_SPRITE(CHARIZARD2, gMonFrontPic_Charizard2),
    ...
    SPECIES_SPRITE(SQUIRTLE2, gMonFrontPic_Squirtle2),
    SPECIES_SPRITE(WARTORTLE2, gMonFrontPic_Wartortle2),
    SPECIES_SPRITE(BLASTOISE2, gMonFrontPic_Blastoise2),
    ...
    SPECIES_SPRITE(NIDOKING, gMonFrontPic_Nidoking),
      ...
      SPECIES_SPRITE(NIDORAN_M1, gMonFrontPic_NidoranM1),
    SPECIES_SPRITE(NIDORINO1, gMonFrontPic_Nidorino1),
    SPECIES_SPRITE(NIDOKING1, gMonFrontPic_Nidoking1),
    ...
    SPECIES_SPRITE(MAGIKARP1, gMonFrontPic_Magikarp1),
    SPECIES_SPRITE(GYARADOS1, gMonFrontPic_Gyarados1),
    SPECIES_SPRITE(LAPRAS, gMonFrontPic_Lapras),
     SPECIES_SPRITE(LAPRAS1, gMonFrontPic_Lapras1),
    SPECIES_SPRITE(DITTO, gMonFrontPic_Ditto),
    SPECIES_SPRITE(EEVEE, gMonFrontPic_Eevee),
    SPECIES_SPRITE(EEVEE1, gMonFrontPic_Eevee1),
    SPECIES_SPRITE(VAPOREON, gMonFrontPic_Vaporeon),
    SPECIES_SPRITE(JOLTEON, gMonFrontPic_Jolteon),
    SPECIES_SPRITE(JOLTEON1, gMonFrontPic_Jolteon1),
    ...
    SPECIES_SPRITE(SNORLAX2, gMonFrontPic_Snorlax2),
