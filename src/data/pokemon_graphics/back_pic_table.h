const struct CompressedSpriteSheet gMonBackPicTable[] =
{
    ...
    SPECIES_SPRITE(BULBASAUR2, gMonBackPic_Bulbasaur2),
    SPECIES_SPRITE(IVYSAUR2, gMonBackPic_Ivysaur2),
    ...
    SPECIES_SPRITE(CHARMANDER2, gMonBackPic_Charmander2),
    SPECIES_SPRITE(CHARMELEON2, gMonBackPic_Charmeleon2),
    SPECIES_SPRITE(CHARIZARD2, gMonBackPic_Charizard2),
    ...
    SPECIES_SPRITE(SQUIRTLE2, gMonBackPic_Squirtle2),
    SPECIES_SPRITE(WARTORTLE2, gMonBackPic_Wartortle2),
    ...
    SPECIES_SPRITE(NIDOKING, gMonBackPic_Nidoking),
     ...
     SPECIES_SPRITE(NIDORAN_M1, gMonBackPic_NidoranM1),
    SPECIES_SPRITE(NIDORINO1, gMonBackPic_Nidorino1),
    SPECIES_SPRITE(NIDOKING1, gMonBackPic_Nidoking1),
    ...
    SPECIES_SPRITE(MAGIKARP1, gMonBackPic_Magikarp1),
    SPECIES_SPRITE(GYARADOS1, gMonBackPic_Gyarados1),
    SPECIES_SPRITE(LAPRAS, gMonBackPic_Lapras),
     SPECIES_SPRITE(LAPRAS1, gMonBackPic_Lapras1),
    SPECIES_SPRITE(DITTO, gMonBackPic_Ditto),
    SPECIES_SPRITE(EEVEE, gMonBackPic_Eevee),
    SPECIES_SPRITE(EEVEE1, gMonBackPic_Eevee1),
    SPECIES_SPRITE(VAPOREON, gMonBackPic_Vaporeon),
    SPECIES_SPRITE(JOLTEON, gMonBackPic_Jolteon),
    SPECIES_SPRITE(JOLTEON1, gMonBackPic_Jolteon1),
    ...
    SPECIES_SPRITE(SNORLAX2, gMonBackPic_Snorlax2),
