const u8 *const gMonFootprintTable[] =
{
    ...
    [SPECIES_BULBASAUR2] = gMonFootprint_Bulbasaur2,
    [SPECIES_IVYSAUR2] = gMonFootprint_Ivysaur2,
    ...
    [SPECIES_CHARMANDER2] = gMonFootprint_Charmander2,
    [SPECIES_CHARMELEON2] = gMonFootprint_Charmeleon2,
    [SPECIES_CHARIZARD2] = gMonFootprint_Charizard2,
    ...
    [SPECIES_SQUIRTLE2] = gMonFootprint_Squirtle2,
    [SPECIES_WARTORTLE2] = gMonFootprint_Wartortle2,
    ...
    [SPECIES_NIDORAN_M1] = gMonFootprint_NidoranM1,
    [SPECIES_NIDORINO1] = gMonFootprint_Nidorino1,
    [SPECIES_NIDOKING1] = gMonFootprint_Nidoking1,
    ...
    [SPECIES_GYARADOS] = gMonFootprint_Gyarados,
     [SPECIES_MAGIKARP1] = gMonFootprint_Magikarp1,
    [SPECIES_GYARADOS1] = gMonFootprint_Gyarados1,
    [SPECIES_LAPRAS] = gMonFootprint_Lapras,
    [SPECIES_LAPRAS1] = gMonFootprint_Lapras1,
    [SPECIES_DITTO] = gMonFootprint_Ditto,
    [SPECIES_EEVEE] = gMonFootprint_Eevee,
    [SPECIES_EEVEE1] = gMonFootprint_Eevee1,
    [SPECIES_VAPOREON] = gMonFootprint_Vaporeon,
    [SPECIES_JOLTEON] = gMonFootprint_Jolteon,
    [SPECIES_JOLTEON1] = gMonFootprint_Jolteon1,
    ...
    [SPECIES_SNORLAX] = gMonFootprint_Snorlax,
     [SPECIES_SNORLAX2] = gMonFootprint_Snorlax2,
