const struct CompressedSpritePalette gMonShinyPaletteTable[] =
{
    ...
    SPECIES_SHINY_PAL(BULBASAUR2, gMonShinyPalette_Bulbasaur2),
    SPECIES_SHINY_PAL(IVYSAUR2, gMonShinyPalette_Ivysaur2),
    SPECIES_SHINY_PAL(VENUSAUR2, gMonShinyPalette_Venusaur2),
    ...
    SPECIES_SHINY_PAL(CHARMANDER2, gMonShinyPalette_Charmander2),
    SPECIES_SHINY_PAL(CHARMELEON2, gMonShinyPalette_Charmeleon2),
    SPECIES_SHINY_PAL(CHARIZARD2, gMonShinyPalette_Charizard2),
    ...
    SPECIES_SHINY_PAL(SQUIRTLE2, gMonShinyPalette_Squirtle2),
    SPECIES_SHINY_PAL(WARTORTLE2, gMonShinyPalette_Wartortle2),
    SPECIES_SHINY_PAL(BLASTOISE2, gMonShinyPalette_Blastoise2),
    ...
    SPECIES_SHINY_PAL(NIDOKING, gMonShinyPalette_Nidoking),
     ...
     SPECIES_SHINY_PAL(NIDORAN_M1, gMonShinyPalette_NidoranM1),
    SPECIES_SHINY_PAL(NIDORINO1, gMonShinyPalette_Nidorino1),
    SPECIES_SHINY_PAL(NIDOKING1, gMonShinyPalette_Nidoking1),
    ...
    SPECIES_SHINY_PAL(MAGIKARP1, gMonShinyPalette_Magikarp1),
    SPECIES_SHINY_PAL(GYARADOS1, gMonShinyPalette_Gyarados1),
    SPECIES_SHINY_PAL(LAPRAS, gMonShinyPalette_Lapras),
    SPECIES_SHINY_PAL(LAPRAS1, gMonShinyPalette_Lapras1),
    SPECIES_SHINY_PAL(DITTO, gMonShinyPalette_Ditto),
    SPECIES_SHINY_PAL(EEVEE, gMonShinyPalette_Eevee),
      SPECIES_SHINY_PAL(EEVEE1, gMonShinyPalette_Eevee1),
    SPECIES_SHINY_PAL(VAPOREON, gMonShinyPalette_Vaporeon),
    SPECIES_SHINY_PAL(JOLTEON, gMonShinyPalette_Jolteon),
      SPECIES_SHINY_PAL(JOLTEON1, gMonShinyPalette_Jolteon1),
    ...
    SPECIES_SHINY_PAL(SNORLAX2, gMonShinyPalette_Snorlax2),
