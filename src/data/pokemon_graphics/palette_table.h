const struct CompressedSpritePalette gMonPaletteTable[] =
{
    ...
    SPECIES_PAL(BULBASAUR2, gMonPalette_Bulbasaur2),
    SPECIES_PAL(IVYSAUR2, gMonPalette_Ivysaur2),
    SPECIES_PAL(VENUSAUR2, gMonPalette_Venusaur2),
    ...
    SPECIES_PAL(CHARMANDER2, gMonPalette_Charmander2),
    SPECIES_PAL(CHARMELEON2, gMonPalette_Charmeleon2),
    SPECIES_PAL(CHARIZARD2, gMonPalette_Charizard2),
    ...
    SPECIES_PAL(SQUIRTLE2, gMonPalette_Squirtle2),
    SPECIES_PAL(WARTORTLE2, gMonPalette_Wartortle2),
    SPECIES_PAL(BLASTOISE2, gMonPalette_Blastoise2),
    ...
    SPECIES_PAL(NIDORAN_M1, gMonPalette_NidoranM1),
    SPECIES_PAL(NIDORINO1, gMonPalette_Nidorino1),
    SPECIES_PAL(NIDOKING1, gMonPalette_Nidoking1),
    ...
    SPECIES_PAL(MAGIKARP1, gMonPalette_Magikarp1),
    SPECIES_PAL(GYARADOS1, gMonPalette_Gyarados1),
    SPECIES_PAL(LAPRAS, gMonPalette_Lapras),
    SPECIES_PAL(LAPRAS1, gMonPalette_Lapras1),
    SPECIES_PAL(DITTO, gMonPalette_Ditto),
    SPECIES_PAL(EEVEE, gMonPalette_Eevee),
    SPECIES_PAL(EEVEE1, gMonPalette_Eevee1),
    SPECIES_PAL(VAPOREON, gMonPalette_Vaporeon),
    SPECIES_PAL(JOLTEON, gMonPalette_Jolteon),
    SPECIES_PAL(JOLTEON1, gMonPalette_Jolteon1),
    ...
    SPECIES_PAL(SNORLAX, gMonPalette_Snorlax),
     SPECIES_PAL(SNORLAX2, gMonPalette_Snorlax2),
