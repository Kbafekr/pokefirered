...
static const u16 sBulbasaur2LevelUpLearnset[] = {
    LEVEL_UP_MOVE(1, MOVE_TACKLE),
    LEVEL_UP_MOVE(4, MOVE_GROWL),
...
static const u16 sIvysaur2LevelUpLearnset[] = {
    LEVEL_UP_MOVE(1, MOVE_TACKLE),
    LEVEL_UP_MOVE(1, MOVE_GROWL),
    LEVEL_UP_MOVE(1, MOVE_LEECH_SEED),
    LEVEL_UP_MOVE(4, MOVE_GROWL),
...
static const u16 sVenusaur2LevelUpLearnset[] = {
    LEVEL_UP_MOVE(1, MOVE_TACKLE),
    LEVEL_UP_MOVE(1, MOVE_GROWL),
    LEVEL_UP_MOVE(1, MOVE_LEECH_SEED),
    LEVEL_UP_MOVE(1, MOVE_VINE_WHIP),
...
static const u16 sCharmander2LevelUpLearnset[] = {
    LEVEL_UP_MOVE(1, MOVE_SCRATCH),
...
static const u16 sCharmeleon2LevelUpLearnset[] = {
    LEVEL_UP_MOVE(1, MOVE_SCRATCH),
    LEVEL_UP_MOVE(1, MOVE_GROWL),
    LEVEL_UP_MOVE(1, MOVE_EMBER),
    LEVEL_UP_MOVE(7, MOVE_EMBER),
...
static const u16 sCharizard2LevelUpLearnset[] = {
    LEVEL_UP_MOVE(1, MOVE_HEAT_WAVE),
    LEVEL_UP_MOVE(1, MOVE_SCRATCH),
    LEVEL_UP_MOVE(1, MOVE_GROWL),
    LEVEL_UP_MOVE(1, MOVE_EMBER),
...
static const u16 sSquirtle2LevelUpLearnset[] = {
    LEVEL_UP_MOVE(1, MOVE_TACKLE),
    LEVEL_UP_MOVE(4, MOVE_TAIL_WHIP),
...
static const u16 sWartortle2LevelUpLearnset[] = {
    LEVEL_UP_MOVE(1, MOVE_TACKLE),
    LEVEL_UP_MOVE(1, MOVE_TAIL_WHIP),
    LEVEL_UP_MOVE(1, MOVE_BUBBLE),
    LEVEL_UP_MOVE(4, MOVE_TAIL_WHIP),
...
static const u16 sBlastoise2LevelUpLearnset[] = {
    LEVEL_UP_MOVE(1, MOVE_TACKLE),
    LEVEL_UP_MOVE(1, MOVE_TAIL_WHIP),
    LEVEL_UP_MOVE(1, MOVE_BUBBLE),
    LEVEL_UP_MOVE(1, MOVE_WITHDRAW),
...
static const u16 sNidoranM1LevelUpLearnset[] = {
    LEVEL_UP_MOVE(1, MOVE_LEER),
    LEVEL_UP_MOVE(1, MOVE_PECK),
...
static const u16 sNidorino1LevelUpLearnset[] = {
    LEVEL_UP_MOVE(1, MOVE_LEER),
    LEVEL_UP_MOVE(1, MOVE_PECK),
    LEVEL_UP_MOVE(8, MOVE_FOCUS_ENERGY),
    LEVEL_UP_MOVE(12, MOVE_DOUBLE_KICK),
...
static const u16 sNidoking1LevelUpLearnset[] = {
    LEVEL_UP_MOVE(1, MOVE_PECK),
    LEVEL_UP_MOVE(1, MOVE_FOCUS_ENERGY),
    LEVEL_UP_MOVE(1, MOVE_DOUBLE_KICK),
    LEVEL_UP_MOVE(1, MOVE_POISON_STING),
...
static const u16 sMagikarp1LevelUpLearnset[] = {
    LEVEL_UP_MOVE(1, MOVE_SPLASH),
    LEVEL_UP_MOVE(15, MOVE_TACKLE),
...
static const u16 sGyarados1LevelUpLearnset[] = {
...
static const u16 sLapras1LevelUpLearnset[] = {
    LEVEL_UP_MOVE(1, MOVE_WATER_GUN),
    LEVEL_UP_MOVE(1, MOVE_CONFUSION),
    LEVEL_UP_MOVE(1, MOVE_SING),
    LEVEL_UP_MOVE(7, MOVE_MIST),
...
static const u16 sEevee1LevelUpLearnset[] = {
    LEVEL_UP_MOVE(1, MOVE_TACKLE),
    LEVEL_UP_MOVE(1, MOVE_TAIL_WHIP),
    LEVEL_UP_MOVE(1, MOVE_HELPING_HAND),
    LEVEL_UP_MOVE(8, MOVE_SAND_ATTACK),
...
static const u16 sJolteon1LevelUpLearnset[] = {
    LEVEL_UP_MOVE(1, MOVE_TACKLE),
    LEVEL_UP_MOVE(1, MOVE_TAIL_WHIP),
    LEVEL_UP_MOVE(1, MOVE_HELPING_HAND),
    LEVEL_UP_MOVE(8, MOVE_SAND_ATTACK),
...
static const u16 sSnorlax2LevelUpLearnset[] = {
    LEVEL_UP_MOVE(1, MOVE_TACKLE),
    LEVEL_UP_MOVE(5, MOVE_AMNESIA),
    LEVEL_UP_MOVE(9, MOVE_DEFENSE_CURL),
    LEVEL_UP_MOVE(13, MOVE_BELLY_DRUM),
