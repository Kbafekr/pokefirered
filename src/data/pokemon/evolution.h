const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
    ...
    [SPECIES_BULBASAUR2]  = {{EVO_LEVEL, 16, SPECIES_IVYSAUR2}},
    [SPECIES_IVYSAUR2]    = {{EVO_LEVEL, 32, SPECIES_VENUSAUR2}},
    [SPECIES_CHARMANDER] = {{EVO_LEVEL, 16, SPECIES_CHARMELEON}},
    [SPECIES_CHARMELEON] = {{EVO_LEVEL, 36, SPECIES_CHARIZARD}},
    [SPECIES_CHARMANDER2] = {{EVO_LEVEL, 16, SPECIES_CHARMELEON2}},
    [SPECIES_CHARMELEON2] = {{EVO_LEVEL, 36, SPECIES_CHARIZARD2}},
    [SPECIES_SQUIRTLE]   = {{EVO_LEVEL, 16, SPECIES_WARTORTLE}},
    [SPECIES_WARTORTLE]  = {{EVO_LEVEL, 36, SPECIES_BLASTOISE}},
    [SPECIES_SQUIRTLE2]   = {{EVO_LEVEL, 16, SPECIES_WARTORTLE2}},
    [SPECIES_WARTORTLE2]  = {{EVO_LEVEL, 36, SPECIES_BLASTOISE2}},
    ...
    [SPECIES_NIDORAN_M1]  = {{EVO_LEVEL, 16, SPECIES_NIDORINO1}},
    [SPECIES_NIDORINO1]   = {{EVO_LEVEL, 43, SPECIES_NIDOKING1}},
